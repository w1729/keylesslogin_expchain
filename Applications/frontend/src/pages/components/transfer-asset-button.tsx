  ...
  return (
    <Stack direction={'row'} spacing={4}>
      <Tooltip title="Coming soon">
        <Stack justifyContent="center" alignItems="center" spacing={'4px'} sx={{ cursor: 'not-allowed', opacity: 0.5 }}>
      ...
      <Stack justifyContent="center" alignItems="center" spacing={'4px'} sx={{ cursor: 'pointer' }}>
        <Avatar sx={{ bgcolor: theme.palette.primary.main }}>
          <SendRoundedIcon
      ...
      <Tooltip title="Coming soon">
        ...
        >
          <Avatar sx={{ bgcolor: theme.palette.primary.main }}>
            <AccountBalanceRoundedIcon sx={{ ml: '4px', mb: '6px' }} />
          </Avatar>
          <Typography variant="button">Loan</Typography>
        </Stack>
      </Tooltip>
    </Stack>
  );
